      ...
      },
      {
        ...
        meta: {
          ...
          privilege: [
            {
              title: '查询',
              name: 'access-black-query'
            },
            {
              title: '添加',
              name: 'access-black-add'
            },
            {
              title: '编辑',
              name: 'access-black-update'
            },
            {
              title: '删除',
              name: 'access-black-delete'
            }
          ]
        },
        component: () => import('@/views/system/system-setting/access-black/access-black.vue')
      }
    ]
  }
];

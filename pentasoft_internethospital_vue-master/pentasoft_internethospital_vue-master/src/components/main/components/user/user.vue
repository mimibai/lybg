<template>
  <div class="user-avatar-dropdown">
    <Dropdown @on-click="handleClick">
      <label style="font-size: 14px; margin-left: 6px">{{
        loginInfo.actualName
      }}</label>
      <Icon
        :size="6"
        class="dropdown-arrows"
        type="icon iconfont iconxiangxiala"
      ></Icon>
      <Avatar
        :src="loginInfo.header || defaultIcon"
        class="head"
        icon="ios-person"
        size="small"
      />
...
import { localRead, TOKEN_KEY } from '@/lib/local';

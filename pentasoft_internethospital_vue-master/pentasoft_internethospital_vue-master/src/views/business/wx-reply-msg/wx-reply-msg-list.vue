      ...
      <Row class="smart-query-form-row">
        ...
        <span>
          ...
          <Input
            ...
            style="width: 180px"
            v-model="queryForm.weiXinUserId"
          />
        </span>
        <span>
          回复内容 :
        ...
        <ButtonGroup>
          <Button
            ...
            icon="ios-search"
            type="primary"
            v-privilege="'wx-reply-msg-list-query'"
            >查询</Button
          >
          <Button
      ...
      <Form :label-width="80">
        ...
        <FormItem label="删除数据">
          <Card style="width: 350px; height: 250px; overflow-y: scroll">
            <ul>
              <li v-for="item in mainTableSelectArray" :key="item.weiXinReplyMsgId">
                <a href="#">{{ item.name }}</a>
              </li>
            </ul>
          </Card>
...
import WxReplyMsgListForm from "./components/wx-reply-msg-list-form";
import { WX_ACCOUNT_TYPES } from "@/constants/enum-wx";
const PAGE_SIZE_INIT = 20;
export default {
  name: "WeixinreplymsgList",
  components: {
    WxReplyMsgListForm,
  },
  props: {},
      ...
      mainTable: {
        ...
        columnArray: [
          ...
          },
          {
            title: "微信用户ID",
            key: "weiXinUserId",
            tableColumn: "ybj_weixinreplymsgs.WeiXinUserId",
            sortable: "custom",
          },
          {
            title: "微信号类别",
            ...
            render: (h, params) => {
              "span",
                this.$enum.getDescByValue(
                  "WX_ACCOUNT_TYPES",
                  params.row.weiXinAccountTypeId
                );
            },
          },
          {
            title: "用户消息",
            key: "weiXinInputContentId",
            tableColumn: "ybj_weixinreplymsgs.WeiXinInputContentId",
            sortable: "custom",
          },
          {
            title: "回复内容",
            key: "content",
            tableColumn: "ybj_weixinreplymsgs.Content",
            sortable: "custom",
          },
          {
            title: "回复人",
            key: "userId",
            tableColumn: "ybj_weixinreplymsgs.UserId",
            sortable: "custom",
          },
          {
            title: "是否删除",
              ...
              let actions = [
                {
                  ...
                  directives: [
                    {
                      name: "privilege",
                      value: "wx-reply-msg-list-update",
                    },
                  ],
                  action: () => {
                    this.showEditWeixinreplymsgForm(params.row);
                  },
                },
                {
                  title: "删除",
                  directives: [
                    {
                      name: "privilege",
                      value: "wx-reply-msg-list-delete",
                    },
                  ],
                  action: () => {
                    this.$Modal.confirm({
                      ...
                      content: "确定要删除吗？",
                      onOk: () => {
                        this.deleteWeixinreplymsg(params.row.weiXinReplyMsgId);
                      },
                    });
                  },
                },
  ...
  methods: {
    ...
    async queryList() {
      ...
      try {
        ...
        let result = await wxReplyMsgApi.queryWeixinreplymsg(params);
    ...
    /*-------------------------删除 begin------------------------- */
    // 根据ID删除
    async deleteWeixinreplymsg(weiXinReplyMsgId) {
      try {
        this.isShowdeleteLoading = true;
        let result = await wxReplyMsgApi.deleteWeixinreplymsg(weiXinReplyMsgId);
    ...
    async batchDelete() {
      this.$Spin.show();
      await wxReplyMsgApi.batchDeleteWeixinreplymsg(
        this.mainTableSelectArray.map((e) => e.weiXinReplyMsgId)
      );
    ...
    async exportAll() {
      try {
        ...
        let params = this.convertQueryParam();
        await wxReplyMsgApi.exportAll(params);
      } catch (e) {
        console.log(e);
      } finally {
    ...
    async batchExport() {
      ...
      try {
        ...
        await wxReplyMsgApi.batchExport(
          this.mainTableSelectArray.map((e) => e.weiXinReplyMsgId)
        );
      } catch (e) {
        console.log(e);
    ...
    /*-------------------------添加，修改 表单 begin------------------------- */
    //显示添加表单
    showAddWeixinreplymsgForm() {
      this.saveModal.isUpdate = false;
      this.saveModal.show = true;
    },
    showEditWeixinreplymsgForm(updateObject) {

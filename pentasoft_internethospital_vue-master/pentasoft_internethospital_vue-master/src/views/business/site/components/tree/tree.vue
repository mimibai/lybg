    ...
    >
      <div class="ats-input-single" v-if="!this.multiple">
        <i
          ...
          :class="{
            'is-reverse': treeVisible,
            'el-icon-circle-close': showCloseIcon,
          }"
        ...
        <div class="ats-labels">
          <div class="el-select__tags" @click.prevent="handleCloseTree(true)">
            <Tag
              ...
              @on-close="handleDelItem(item, $event)"
...
import { objArrDeepCopy } from "@/lib/tools";
...
export default {
  ...
  methods: {
    ...
    setErrorMessage(data) {
      ...
      this.error.message = "id不存在:" + errorText;

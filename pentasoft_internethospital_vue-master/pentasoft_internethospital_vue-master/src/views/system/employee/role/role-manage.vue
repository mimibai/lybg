    ...
    <Col :lg="19" :md="16">
      <Card class="warp-card" dis-hover>
        ...
        <Menu :active-name="displayTab" @on-select="selectTab" mode="horizontal" style="z-index: 1">
          ...
          <MenuItem :name="2">
            <Icon type="ios-paper" />部门权限
          </MenuItem>
          <MenuItem :name="3">
            <Icon type="ios-paper" />内容权限设置
          </MenuItem>
           <MenuItem :name="4">
            <Icon type="ios-paper" />组织人员设置
          </MenuItem>
          <MenuItem :name="5">
            <Icon type="ios-paper" />微信管理
          </MenuItem>
          <MenuItem :name="6">
        ...
        <!--部门权限-->
        <RoleDataScope :roleId="roleId" :dataScopeType="1" v-if="displayTab==2"></RoleDataScope>
        <!--内容权限设置-->
        <RoleDataScope :roleId="roleId" :dataScopeType="2" v-if="displayTab==3"></RoleDataScope>
        <!--组织人员设置-->
        <RoleDataScope :roleId="roleId" :dataScopeType="7" v-if="displayTab==4"></RoleDataScope>
        <!--微信管理-->
        <RoleDataScope :roleId="roleId" :dataScopeType="6" v-if="displayTab==5"></RoleDataScope>
        <!--成员管理-->
        <RoleList :roleId="roleId" v-if="displayTab==6"></RoleList>
      </Card>
    </Col>
    <!-- Col 功能列表 end -->
  </Row>
